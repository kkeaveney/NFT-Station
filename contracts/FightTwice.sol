...
contract FightTwice is VRFConsumerBase, IERC721Receiver {
    ...
    */
    ...
    // before this, we need to sned LINK tokens to this contract
    ...
    internal override {
        ...
        if(randomNumber.mod(2) == 0 || NFTsLen == 0) {
            ...
            // bet we lose all NFTs, save this NFT in our database
            NFTs.push(
                NFT(
            ...
            // better won another k NFTs
            // use the randomNumber to find an NFT
    ...
    // @param _from the address which previously owner the token
    ...
    function onERC721Received(address, address _from, uint256 _tokenId, bytes memory _data) public override returns (bytes4) {
        ...
        bet(msg.sender, _from, _tokenId, sliceUnit(_data, 0));
        return this.onERC721Received.selector;
    }

    function sliceUnit(bytes memory bs, uint256 start)
